...
list_of_prices = []
list_of_volumes = []
oil_dicit = {}                      #dictionary for exercise E) 
...
#    print(list_of_volumes)
    ...
    return list_of_dates, list_of_dates_changed, list_of_prices, list_of_volumes #Make lists avaible outside of function

list_of_dates, list_of_dates_changed, list_of_prices, list_of_volumes = data_cleaning() #Make lists avaible outside of function
...
def info_to_dicitonary():
    ...
    for line in lines:                  #Looping over the lines and adding the data
        ...
        list_of_volumes.append(float(data[2]))
...
highlow(list_of_dates_changed, list_of_prices)    #Start E).

info_to_dicitonary()   #Start F).
